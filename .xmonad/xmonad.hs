...
trayer <- spawn "killall trayer; sleep 0.1;trayer --edge bottom --align right --SetDockType true --SetPartialStrut true --expand true --width 12 --transparent true --alpha 0 --tint 0x000000 --height 14 &"
